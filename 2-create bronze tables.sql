...
===============================================================================
Script Purpose:
    This script creates tables in the 'bronze' schema of CRM and ERP data, dropping existing tables 
...
IF OBJECT_ID ('bronze.erp_customer_details' , 'U') IS NOT NULL
	DROP TABLE bronze.erp_customer_details
...
IF OBJECT_ID('bronze.erp_product_catagory' , 'U') IS NOT NULL
	DROP TABLE bronze.erp_product_catagory
CREATE TABLE bronze.erp_product_catagory(
    id           NVARCHAR(50),
    cat          NVARCHAR(50),
    subcat       NVARCHAR(50),
